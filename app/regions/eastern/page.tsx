    ...
    <div className="region-page">
      ...
      <header className="region-header">
        <div className="header-content pt-20">
          ...
          <p className="region-description">تُعد المنطقة الشرقية من أهم مناطق المملكة العربية السعودية، حيث تقع على ساحل الخليج العربي وتضم مدناً رئيسية كالدمام والخبر والظهران، مما يجعلها قلباً اقتصادياً وتجارياً مهماً.
تمتاز بتراث غني وواحة الأحساء، إحدى أكبر الواحات الزراعية في العالم، التي تعكس تاريخ المنطقة الحضاري.
كما تبرز فيها مظاهر الثقافة الأصيلة من خلال الأهازيج الشعبية والعادات والتقاليد المتوارثة.
تجمع المنطقة بين عبق الماضي وحيوية الحاضر، لتبقى رمزاً للهوية السعودية وجسراً يربط التراث بالتنمية الحديثة..</p>
        </div>
      </header>
